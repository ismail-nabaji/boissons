            ...
            <div class="inner">
                ...
                <?php
                    ...
                    if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true) {
                        ...
                        // Requête SQL pour récupérer les informations des recettes dans le panier de l'utilisateur
                        ...
                        if(isset($_SESSION['panier_temporaire']) && !empty($_SESSION['panier_temporaire'])){
                            ...
                            foreach ($_SESSION['panier_temporaire'] as $resultat) {
                                echo "<li>" . $resultat;
                                echo "<form action='' method='post'>";
                                echo "<input type='hidden' id='titreRecette' name='titreRecette' value=\"" . $resultat . "\" />";
                                echo "<input type='submit' name='supprimer_panier' class='button big' value='Supprimer du panier'/>";
                                echo "</form>";
                                echo "</li>";
                            }
